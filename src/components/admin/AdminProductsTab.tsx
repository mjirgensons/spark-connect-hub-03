...
import { Plus, Pencil, Trash2, Sparkles, AlertTriangle, ImageOff, RotateCcw, Trash, Power, PowerOff, ArrowUp, ArrowDown, ArrowUpDown } from "lucide-react";
    ...
    <>
      <div className="flex items-center justify-between mb-4">
        <div className="flex gap-2">
          <Button variant="default" size="sm" className="border-2">
