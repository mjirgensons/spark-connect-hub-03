      ...
      <div className="max-w-md text-center space-y-6">
        ...
        <div className="border-2 border-foreground bg-card p-8 space-y-4" style={{ boxShadow: "6px 6px 0 0 hsl(var(--foreground))" }}>
          ...
          <p className="text-muted-foreground">
            Thank you for registering as a seller on Fitmatch. Our team is reviewing your application. You will receive an email when your account is approved. This usually takes 1–2 business days.
          </p>
        </div>
