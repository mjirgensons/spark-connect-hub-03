...
const ContractorMessages = () => (
  <div className="space-y-6">
    <Breadcrumbs items={[{ label: "Dashboard", href: "/contractor/dashboard" }, { label: "Messages" }]} />
    ...
    <Card className="border-2 border-foreground p-8 text-center" style={{ boxShadow: "4px 4px 0 0 hsl(var(--foreground))" }}>
      ...
      <p className="text-sm text-muted-foreground">
        Your FitMatch assistant is available via the chat widget in the bottom-right corner. Direct messaging with clients is coming soon.
      </p>
    </Card>
  </div>
);
